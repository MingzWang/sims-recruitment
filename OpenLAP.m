...
trackfile = 'OpenTRACK Tracks/OpenTRACK_Spa-Francorchamps_Open_Forward.mat' ;
...
function [sim] = simulate(veh,tr,simname,logid)
    ...
    x = -v_max;                       % we want peaks of -v_max
apex = find(islocalmax(x));       % locations of local maxima of x
v_apex = v_max(apex);             % convert back: v_apex = v_max at apex
